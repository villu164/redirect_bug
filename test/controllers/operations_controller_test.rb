...
class OperationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create operation" do
    assert_difference('Operation.count') do
      post operations_url, params: { operation: { encryption_key: @operation.encryption_key, name: @operation.name } }
    end
  ...
  test "should update operation" do
    patch operation_url(@operation), params: { operation: { encryption_key: @operation.encryption_key, name: @operation.name } }
